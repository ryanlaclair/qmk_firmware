...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    [_PAREN] = LAYOUT(
        _______, KC_MINS, KC_EQL, _______, _______, _______, _______, _______, KC_MINS, KC_EQL, KC_LPRN, KC_RPRN, _______,
        _______, KC_UNDS, KC_PLUS, _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, _______,
