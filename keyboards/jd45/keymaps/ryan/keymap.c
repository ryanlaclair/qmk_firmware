...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    [_PAREN] = LAYOUT(
        _______, KC_GRV, _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL, _______,
        _______, KC_TILD, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_UNDS, KC_PLUS, _______,
