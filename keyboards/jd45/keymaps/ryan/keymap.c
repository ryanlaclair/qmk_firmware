...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FN2), MO(_FN1), KC_SPC, KC_RGUI, KC_RALT, MO(_FN1), KC_RCTL),
    [_FN1] = LAYOUT(
        ...
        KC_LSFT, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_QUOT, KC_BSLS,
    ...
    [_FN2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_BSPC,
